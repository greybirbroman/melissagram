    ...
    <Form {...form}>
      <div className='sm:w-420 flex-center flex-col'>
        ...
        <p className='text-light-3 small-medium md:base-regular mt-2'>
          To use Melissagram, please enter your account details
        </p>
        <form
        ...
        >
          ...
          <p className='text-small-regular text-light-2 text-center mt-2 flex items-center justify-center gap-1'>
